...
import logo from '/logoStudy2.png';
          ...
          <div className="container mx-auto py-8 px-4">
            <div className="flex flex-wrap justify-between">
              <div className="w-full sm:w-1/2 md:w-auto mb-4">
                ...
                <h2 className="text-2xl font-bold mb-2">CampusEase</h2>
                <p className="text-gray-300">
                  Explore our wide range of CampusEase and find your favorite
                  College!
                </p>
              </div>
                ...
                <div className="max-w-4xl">
                  ...
                  <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-2">
                    <div>
                      <label
                        htmlFor="name"
                        className="block text-[#6fb9b9] font-bold mb-2"
                      >
                        Name
                      </label>
                      <input
                        ...
                        required
                        className="border text-neutral border-[#6fb9b9] p-2 w-full rounded-md"
                      />
                    </div>
                    <div>
                      <label
                    ...
                    <div className="col-span-2">
                      ...
                      <textarea
                        ...
                        required
                        className="border text-neutral border-[#6fb9b9] h-[3rem] p-2 w-full rounded-md"
                        rows="5"
                      ></textarea>
                    </div>
                    <div className="col-span-2">
                      <input
                        value="Submit"
                        type="submit"
                        className="btn bg-[#6fb9b9] hover:bg-slate-50 hover:text-[#6fb9b9] text-white"
                      ></input>
                    </div>
                  </form>
                </div>
