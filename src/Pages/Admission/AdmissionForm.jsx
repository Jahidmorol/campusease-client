    ...
    const {
      ...
      return (
        <div className="mx-auto p-4 w-[60%] bg-transparent md:my-8">
          <h2 className="text-2xl text-center mb-8 font-bold ">{collegeName} Admission Form</h2>
          <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="mb-4">
              ...
              {errors.candidateEmail && (
                <span className="text-red-500">{errors.candidateEmail.message}</span>
              )}
            </div>
            <div className="mb-4">
              ...
              <input
                type="tel"
                id="candidatePhone"
                {...register('candidatePhone', { required: 'Candidate Phone is required' })}
                className="w-full border border-gray-400 p-2 rounded-md"
              />
              {errors.candidatePhone && (
                <span className="text-red-500">{errors.candidatePhone.message}</span>
              )}
            </div>
            <div className="mb-4">
